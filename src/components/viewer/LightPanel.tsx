...
export default function LightPanel() {
  ...
  return (
    <div className="absolute top-14 right-3 z-40 w-56 rounded-lg border border-white/10 bg-[#0d1117]/95 p-3 text-xs backdrop-blur-sm shadow-xl">
      ...
      {/* Sun Intensity */}
      <label className="mb-1 block text-white/50">Sun Intensity</label>
      <input
        type="range"
        min="0"
        max="5"
      ...
      {/* Ambient */}
      <label className="mb-1 block text-white/50">Ambient Fill</label>
      <input
        type="range"
        min="0"
        max="2"
      ...
      <label className="mb-1 block text-white/50">Sun Azimuth</label>
      <input
        type="range"
        min="0"
        max="360"
      ...
      {/* Sun Elevation */}
      <label className="mb-1 block text-white/50">Sun Height</label>
      <input
        type="range"
        min="1"
        max="50"
